...
extern EIF_TYPED_VALUE F1613_18239(EIF_REFERENCE);
extern void F1613_18240(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1613_18239 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1613_18240 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1612, Current, 0, 0, 24942);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1612, Current, 24942);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14848, 0xF80006BF, 0); /* implementation */
