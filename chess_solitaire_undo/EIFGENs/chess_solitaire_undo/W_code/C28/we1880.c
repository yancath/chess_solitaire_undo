...
extern void F1880_22654(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1880_22655(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1880_22656(EIF_REFERENCE);
...
void F1880_22654 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1879, Current, 0, 1, 28664);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1879, Current, 28664);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(18797, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
...
void F1880_22655 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1879, Current, 1, 1, 28665);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1879, Current, 28665);
	RTCC(arg1, 1879, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1880_22656 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1879, Current, 1, 0, 28666);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1879, Current, 28666);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
