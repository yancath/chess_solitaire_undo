...
extern void F1805_20693(EIF_REFERENCE);
extern void F1805_20694(EIF_REFERENCE);
...
void F1805_20693 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1804, Current, 0, 0, 26783);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1804, Current, 26783);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1805_20694 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1804, Current, 0, 0, 26784);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1804, Current, 26784);
	RTIV(Current, RTAL);
