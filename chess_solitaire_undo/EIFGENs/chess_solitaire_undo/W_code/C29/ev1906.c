...
extern EIF_TYPED_VALUE F1906_23086(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1906_23087(EIF_REFERENCE);
extern void F1906_23088(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1906_23089(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1906_23090(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1906_23086 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1905, Current, 1, 0, 29088);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1905, Current, 29088);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1906_23087 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1905, Current, 1, 0, 29089);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1905, Current, 29089);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1906_23088 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1905, Current, 0, 1, 29090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1905, Current, 29090);
	RTCC(arg1, 1905, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		if (tb1) {
			RTHOOK(4);
			RTDBGAA(Current, dtype, 19149, 0xF80000EE, 0); /* internal_text */
		...
		RTHOOK(6);
		RTDBGAA(Current, dtype, 19149, 0xF80000EE, 0); /* internal_text */
		*(EIF_REFERENCE *)(Current + RTWA(19149, dtype)) = (EIF_REFERENCE) NULL;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
EIF_TYPED_VALUE F1906_23089 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(19149,Dtype(Current)));
	return r;
}
...
RTOID (F1906_23090)
EIF_TYPED_VALUE F1906_23090 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1906_23090);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1905, Current, 0, 0, 29092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1905, Current, 29092);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18624, 1904))(Current)).it_i4);
