...
extern EIF_TYPED_VALUE F1964_24858(EIF_REFERENCE);
static EIF_TYPED_VALUE F1964_24859_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1964_24859(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1964_24858 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1963, Current, 0, 0, 30769);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1963, Current, 30769);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_5 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7892, dtype))(Current)).it_i4);
	ti4_6 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10299, dtype))(Current)).it_i4);
	ti4_7 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10298, dtype))(Current)).it_i4);
...
static EIF_TYPED_VALUE F1964_24859_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1963, Current, 0, 0, 30770);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1963, Current, 30770);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1964_24859 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15726, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1964_24859_body (Current)).it_r;
