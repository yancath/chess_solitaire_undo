...
extern EIF_TYPED_VALUE F1790_20305(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1790_20305 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1789, Current, 0, 0, 26449);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1789, Current, 26449);
	RTIV(Current, RTAL);
	RTHOOK(1);
