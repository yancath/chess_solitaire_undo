...
extern EIF_TYPED_VALUE F1822_20845(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1822_20845 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1821, Current, 0, 0, 26929);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1821, Current, 26929);
	RTIV(Current, RTAL);
	RTHOOK(1);
