...
extern void F1461_15719(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1461_15719 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1460, Current, 0, 1, 22330);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1460, Current, 22330);
	RTCC(arg1, 1460, l_feature_name, 1, eif_new_type(1866, 0x01), 0x01);
	RTIV(Current, RTAL);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1460, Current, 0, 0, 22331);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1460, Current, 22331);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	...
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13092, dtype))(Current, up1x)).it_p);
	up1 = tp1;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1460, Current, 0, 0, 22332);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1460, Current, 22332);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(12361, dtype));
	up1 = tp1;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13093, dtype))(Current, up1x)).it_i4);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1460, Current, 0, 0, 22333);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1460, Current, 22333);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1461_15723);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1460, Current, 0, 0, 22334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1460, Current, 22334);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(13091, dtype))(Current)).it_i4);
	Result = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F1461_15724 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1460, Current, 0, 0, 22335);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1460, Current, 22335);
	RTIV(Current, RTAL);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1460, Current, 0, 1, 22336);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1460, Current, 22336);
	RTIV(Current, RTAL);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1460, Current, 0, 1, 22337);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1460, Current, 22337);
	RTIV(Current, RTAL);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1460, Current, 0, 1, 22338);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1460, Current, 22338);
	RTIV(Current, RTAL);
