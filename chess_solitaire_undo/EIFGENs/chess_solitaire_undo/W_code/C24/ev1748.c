...
extern EIF_TYPED_VALUE F1748_19927(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1748_19928(EIF_REFERENCE);
extern void F1748_19936(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1748_19937_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1748_19937(EIF_REFERENCE);
extern void F1748_25685(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1748_19927 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1748_19928 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1747, Current, 2, 0, 26225);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1747, Current, 26225);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1748_19936 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1747, Current, 2, 1, 26221);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1747, Current, 26221);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != loc2)) {
		...
		*(EIF_REAL_32 *)tr1 = (EIF_REAL_32) (tr4_1 * arg1);
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(16654, dtype))(Current, ui4_1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
...
static EIF_TYPED_VALUE F1748_19937_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1747, Current, 0, 0, 26222);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1747, Current, 26222);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1748_19937 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15726, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1748_19937_body (Current)).it_r;
...
void F1748_25685 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1747, Current, 0, 25684);
	RTSA(dtype);
	RTME(dtype, 0);
