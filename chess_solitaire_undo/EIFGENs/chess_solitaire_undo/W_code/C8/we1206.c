...
extern EIF_TYPED_VALUE F1206_12580(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1206_12581(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1206_12582(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1206_12580 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1205, Current, 0, 0, 18866);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1205, Current, 18866);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1206_12581 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
RTOID (F1206_12582)
EIF_TYPED_VALUE F1206_12582 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1205, Current, 0, 0, 18868);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1205, Current, 18868);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800039E, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,926,0xFF01,1881,0xFFFF};
		EIF_TYPE typres0;
	...
	tr2 = RTLN(eif_new_type(1881, 0x01).id);
	tr3 = RTMS_EX_H("WEL Silly Window",16,787402615);
	ur1 = tr3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(18810, Dtype(tr2)))(tr2, ur1x);
	RTNHOOK(1,1);
	ur1 = RTCCL(tr2);
