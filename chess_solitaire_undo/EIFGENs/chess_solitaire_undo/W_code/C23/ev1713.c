...
extern EIF_TYPED_VALUE F1713_19523(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1713_19524(EIF_REFERENCE);
extern void F1713_19525(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1713_19526(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1713_19527(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1713_19523 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1712, Current, 1, 0, 26005);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1712, Current, 26005);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1713_19524 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1712, Current, 1, 0, 26006);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1712, Current, 26006);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16304, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
		...
		Result = RTCCL(tr1);
		Result = RTRV(eif_new_type(1280, 0x00), Result);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
void F1713_19525 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1712, Current, 0, 1, 26007);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1712, Current, 26007);
	RTCC(arg1, 1712, l_feature_name, 1, eif_new_type(1627, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1713_19526 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1712, Current, 0, 0, 26008);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1712, Current, 26008);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16304, 0xF800065B, 0); /* private_pixmap */
...
EIF_TYPED_VALUE F1713_19527 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
