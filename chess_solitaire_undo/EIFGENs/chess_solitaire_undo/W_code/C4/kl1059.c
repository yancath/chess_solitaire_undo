...
extern EIF_TYPED_VALUE F1059_10187(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1059_10188(EIF_REFERENCE);
...
RTOID (F1059_10187)
EIF_TYPED_VALUE F1059_10187 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1058, Current, 0, 0, 16534);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1058, Current, 16534);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF80004EF, 0,0); /* Result */
...
RTOID (F1059_10188)
EIF_TYPED_VALUE F1059_10188 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1058, Current, 0, 0, 16535);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1058, Current, 16535);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (10187,F1059_10187)
	RTOTS (10188,F1059_10188)
}
