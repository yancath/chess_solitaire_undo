...
extern void F1285_13309(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1285_13310(EIF_REFERENCE);
...
void F1285_13309 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1284, Current, 0, 2, 19543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1284, Current, 19543);
	RTCC(arg1, 1284, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1284, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10991, 0xF8000383, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F1285_13310 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1284, Current, 3, 0, 19544);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1284, Current, 19544);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
...
EIF_TYPED_VALUE F1285_13311 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1284, Current, 0, 0, 19545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1284, Current, 19545);
	RTIV(Current, RTAL);
	RTHOOK(1);
