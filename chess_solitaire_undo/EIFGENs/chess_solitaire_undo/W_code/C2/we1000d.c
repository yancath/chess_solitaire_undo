...
static const struct desc_info desc_1000[] = {
	...
	{EIF_NON_GENERIC(0x01A9 /*212*/), 15474, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A9 /*212*/), 15475, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A9 /*212*/), 15476, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0197 /*203*/), 15477, 0xFFFFFFFF},
};
void Init1000(void)
{
	IDSC(desc_1000, 0, 999);
	IDSC(desc_1000 + 1, 1, 999);
	IDSC(desc_1000 + 32, 1016, 999);
}
