...
extern EIF_TYPED_VALUE F1397_14645(EIF_REFERENCE);
...
RTOID (F1397_14645)
EIF_TYPED_VALUE F1397_14645 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1396, Current, 0, 0, 21247);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1396, Current, 21247);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
