...
extern EIF_TYPED_VALUE F1192_12175(EIF_REFERENCE);
...
RTOID (F1192_12175)
EIF_TYPED_VALUE F1192_12175 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1191, Current, 0, 0, 18461);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1191, Current, 18461);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
