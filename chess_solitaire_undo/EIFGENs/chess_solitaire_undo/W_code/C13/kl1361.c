...
extern EIF_TYPED_VALUE F1361_14383(EIF_REFERENCE);
...
RTOID (F1361_14383)
EIF_TYPED_VALUE F1361_14383 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1360, Current, 0, 0, 20944);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1360, Current, 20944);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
