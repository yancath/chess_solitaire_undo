...
extern EIF_TYPED_VALUE F1642_18615(EIF_REFERENCE);
extern void F1642_18616(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1642_18615 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1642_18616 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1641, Current, 0, 0, 25321);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1641, Current, 25321);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14848, 0xF80006DE, 0); /* implementation */
