...
extern EIF_TYPED_VALUE F1715_19535(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1715_19535 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1714, Current, 0, 0, 26011);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1714, Current, 26011);
	RTIV(Current, RTAL);
	RTHOOK(1);
