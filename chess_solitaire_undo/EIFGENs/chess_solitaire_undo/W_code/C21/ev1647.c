...
extern EIF_TYPED_VALUE F1647_18639(EIF_REFERENCE);
extern void F1647_18640(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1647_18639 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1647_18640 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1646, Current, 0, 0, 25343);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1646, Current, 25343);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14848, 0xF80006E1, 0); /* implementation */
