...
extern void F1387_14556(EIF_REFERENCE);
...
/* {ETF_RESET_GAME}.reset_game */
void F1387_14556 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1386, Current, 1, 0, 21108);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1386, Current, 21108);
	RTIV(Current, RTAL);
	RTHOOK(1);
