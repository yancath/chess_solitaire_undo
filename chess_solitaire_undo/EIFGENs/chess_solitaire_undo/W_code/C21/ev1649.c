...
extern EIF_TYPED_VALUE F1649_18651(EIF_REFERENCE);
extern void F1649_18652(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1649_18651 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1649_18652 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1648, Current, 0, 0, 25355);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1648, Current, 25355);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14848, 0xF80006EB, 0); /* implementation */
