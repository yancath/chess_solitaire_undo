/*
 * Code for class reference CHESS_SOLITAIRE_ACCESS
 */
...
extern void F1040_25596(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1039, Current, 0, 0, 16328);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1039, Current, 16328);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1040_25596 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1039, Current, 0, 25595);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
