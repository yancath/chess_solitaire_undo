...
extern EIF_TYPED_VALUE F1821_20843(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1821_20844(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1821_20843 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1820, Current, 0, 0, 26927);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1820, Current, 26927);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1821_20844 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1820, Current, 0, 0, 26928);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1820, Current, 26928);
	RTIV(Current, RTAL);
	RTHOOK(1);
