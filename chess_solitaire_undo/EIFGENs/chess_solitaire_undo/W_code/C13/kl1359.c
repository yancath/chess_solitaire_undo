...
extern EIF_TYPED_VALUE F1359_14361(EIF_REFERENCE);
...
RTOID (F1359_14361)
EIF_TYPED_VALUE F1359_14361 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1358, Current, 0, 0, 20903);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1358, Current, 20903);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000578, 0,0); /* Result */
