...
extern void F1685_19070(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1685_19071(EIF_REFERENCE);
extern void F1685_19072(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1685_19073(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1685_19074(EIF_REFERENCE);
extern void F1685_19075(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1685_19076_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1685_19076(EIF_REFERENCE);
...
void F1685_19070 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1684, Current, 0, 1, 25650);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1684, Current, 25650);
	RTCC(arg1, 1684, l_feature_name, 1, RTWCT(15726, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1685_19071 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1684, Current, 0, 0, 25651);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1684, Current, 25651);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1685_19072 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1684, Current, 0, 0, 25652);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1684, Current, 25652);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
...
EIF_TYPED_VALUE F1685_19073 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1684, Current, 1, 0, 25653);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1684, Current, 25653);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = NULL;
	...
	if (tb1) {
		...
		if (tb1) {
			RTHOOK(4);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9345, dtype))(Current);
			RTHOOK(5);
...
EIF_TYPED_VALUE F1685_19074 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1684, Current, 0, 0, 25654);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1684, Current, 25654);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9348, dtype))(Current, ur1x);
...
void F1685_19075 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1684, Current, 2, 1, 25655);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1684, Current, 25655);
	RTCC(arg1, 1684, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(18393, "silly_main_window", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc2 = RTCCL(tr1);
	...
	if (tb1) {
		RTHOOK(8);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9350, dtype))(Current);
		RTHOOK(9);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = '\0';
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15925, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(12,1);
		ur1 = RTCCL(arg1);
...
static EIF_TYPED_VALUE F1685_19076_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1684, Current, 0, 0, 25656);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1684, Current, 25656);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1685_19076 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15726, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1685_19076_body (Current)).it_r;
